...
import { designationList, domesticcomapnyList, privatecompanyList } from 'src/app/master/option-list'
...
export class ViewOrderComponent implements OnInit {
  ...
  onAustrallianResidentChange(value, i, formnumber) {
    ...
    if (value == "Y") {
      ...
      this.f1?.jointInvestor['controls'][i].controls.foreigntaxfieldCountry.setErrors(null)
      this.f1?.jointInvestor['controls'][i].controls.foreigntaxfieldTin.setErrors(null)
      this.f1?.jointInvestor['controls'][i].controls.foreigntaxfieldResidency.setErrors(null)
  ...
  uploadFileAttachments() {
    ...
    for (let i = 0; i < this.atttachments.length; i++) {
      ...
      uploadItems.append('id', this.clientId);
  ...
  onIndividualChange(value, i) {
    ...
    switch (value) {
      ...
      case 1:
        ...
        this.f2?.individualAttachments['controls'][i].controls.individual_2_categoryA_doc.clearValidators()
        this.f2?.individualAttachments['controls'][i].controls.individual_2_categoryB_doc.clearValidators()
        this.f2?.individualAttachments['controls'][i].controls.individualoption2_files.setErrors(null)
        this.f2?.individualAttachments['controls'][i].controls.individualoption2_files_2.setErrors(null)
        break;
      case 2:
        ...
        this.f2?.individualAttachments['controls'][i].controls.individual_1_doc.clearValidators()
        this.f2?.individualAttachments['controls'][i].controls.individualoption1_files.setErrors(null)
